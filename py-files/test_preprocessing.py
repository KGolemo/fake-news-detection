...
class TestPreprocessing(unittest.TestCase):
    def test_drop_title_and_url(self):
        ...
        self.assertEqual(preprocessing_functions.drop_title_and_url(df_input).columns[1],
                         df_expected.columns[1])
    ...
    def test_drop_empty(self):
        ...
        df_expected = pd.DataFrame(data=[['false', 'tekst1']],
                                   columns=['Verdict', 'Text'])
        self.assertEqual(preprocessing_functions.drop_empty(df_input)['Text'].iloc[-1],
                         df_expected['Text'].iloc[-1])
    ...
    def test_drop_non_polish(self):
        ...
        df_expected = pd.DataFrame(data=[['true', 'polski testowy artykuł']],
                                   columns=['Verdict', 'Text'])
        self.assertEqual(preprocessing_functions.drop_non_polish(df_input)['Text'].iloc[0],
                         df_expected['Text'].iloc[0])
    ...
    def test_drop_unidentified(self):
        ...
        df_expected = pd.DataFrame(data=[['true', 'tekst2']],
                                   columns=['Verdict', 'Text'])
        self.assertEqual(preprocessing_functions.drop_unidentified(df_input)['Text'].iloc[0],
                         df_expected['Text'].iloc[0])
    ...
    def test_drop_twitter(self):
        ...
        df_expected = pd.DataFrame(data=[['true', 'tekst2']],
                                   columns=['Verdict', 'Text'])
        self.assertEqual(preprocessing_functions.drop_twitter(df_input)['Text'].iloc[0],
                         df_expected['Text'].iloc[0])
    ...
    def test_change_verdict_dtype(self):
        ...
        df_expected = pd.DataFrame(data=[[False, 'tekst1'],
                                         [True, 'tekst2']],
                                   columns=['Verdict', 'Text'])
        self.assertEqual(preprocessing_functions.change_verdict_dtype(df_input)['Verdict'].iloc[0],
                         df_expected['Verdict'].iloc[0])
    ...
    def test_drop_short(self):
        ...
        self.assertEqual(preprocessing_functions.drop_short(df_input)['Text'].iloc[0],
                         df_expected['Text'].iloc[0])
    ...
    def test_delete_stop_words(self):
        input = ['przy', 'klasyfikacji', 'tekstu', 'z', 'wykorzystaniem',
                 'przede', 'wszystkim', 'uczenia', 'maszynowego']
